...
(function(Opal) {
  ...
  (function($base, $super) {
    ...
    def.$initialize = TMP_1 = function() {
      var $a, $b, TMP_2, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, level = nil;

      TMP_1.$$p = null;
      Opal.find_super_dispatcher(self, 'initialize', TMP_1, null).apply(self, [$hash2(["width", "height", "border"], {"width": 640, "height": 480, "border": true})]);
      level = $hash2(["grid", "enemies"], {"grid": $hash2(["width", "height", "cell_draw_size"], {"width": 4, "height": 4, "cell_draw_size": 100}), "enemies": 4});
      ...
      return self.enemies['$<<']($scope.get('Enemy').$new(self))}, TMP_2.$$s = self, TMP_2), $a).call($b);
    };
